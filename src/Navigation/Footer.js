        ...
        <Grid item xs={12} sm={12} md={6}>
          <Grid container spacing={24}>
            ...
            <Grid item xs={12} md={3} style={{paddingLeft: "2rem"}}>
              ...
              <Typography  className={classes.footerItem} style={{color: 'blue'}}><a rel="noopener noreferrer" style={{textDecoration: "none",color: 'inherit'}} href="tel:503-747-3726"><span style={{color: 'black'}}>OR</span> 503.747.3726</a></Typography>
